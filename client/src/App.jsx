...
export default function App() {
  ...
  // Set before the state change: unmounting the input fires onBlur, which
  // would otherwise save.
  renameCancelled.current = true;
  setRenamingId(null);
}

function openRowMenu(conversation, trigger) {
  if (menu?.conversation.id === conversation.id) return closeMenu();
...
async function copyMessage(text) {
  ...
  return (
    ...
    <Sidebar
          ...
          openMenuId={menu?.conversation.id}
