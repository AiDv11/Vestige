...
import { ERAS, resolveEra } from "./eras.js";
...
export function buildMessages(era, turns) {
  return [
    // resolveEra, not ERAS[era]: conversations stored before `ww2` became
    // `islamic` would otherwise throw here and never open again.
    { role: "system", content: ERAS[resolveEra(era)].system },
